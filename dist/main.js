...
/***/ "./src/js/interfaces/renderers/ProjectRendererInterface.js":
/*!*****************************************************************!*\
  !*** ./src/js/interfaces/renderers/ProjectRendererInterface.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ ProjectRendererInterface)\n/* harmony export */ });\nclass ProjectRendererInterface {\n  render(projects, container, projectFormatter) {\n    throw new Error(\"Not implemented\");\n  }\n}\n\n//# sourceURL=webpack://todo-list/./src/js/interfaces/renderers/ProjectRendererInterface.js?");
...
/***/ "./src/js/renderers/ProjectRenderer.js":
/*!*********************************************!*\
  !*** ./src/js/renderers/ProjectRenderer.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ ProjectRenderer)\n/* harmony export */ });\n/* harmony import */ var _interfaces_renderers_ProjectRendererInterface_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../interfaces/renderers/ProjectRendererInterface.js */ \"./src/js/interfaces/renderers/ProjectRendererInterface.js\");\n\nclass ProjectRenderer extends _interfaces_renderers_ProjectRendererInterface_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"] {\n  render(projects, container, taskListFormatter, projectFormatter, buttonName) {\n    container.innerHTML = \"\";\n    for (let project of projects) {\n      const buttonName = event.target.textContent;\n      if (project.projectName === buttonName) {\n        const projectLabel = projectFormatter.format(project);\n        container.appendChild(projectLabel);\n        for (let task of project.tasks) {\n          const taskHtml = taskListFormatter.format(task);\n          container.appendChild(taskHtml);\n        }\n      }\n      ;\n    }\n    ;\n  }\n}\n\n//# sourceURL=webpack://todo-list/./src/js/renderers/ProjectRenderer.js?");
